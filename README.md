...
- [favicon.png][favicon]: This is the icon in your browser's address bar. You should change it to whatever you'd like. Author (https://www.flaticon.com/authors/freepik)
